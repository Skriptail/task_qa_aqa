...
тесты реализуют логику только для российских карт ввиду того, что stripe официально не работает в России, для автоматизации тестирования оплаты иностранных карт потребуется прокси/vpn
